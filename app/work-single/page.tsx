							...
							<div className="row">
								...
								<div className="d-flex flex-wrap justify-content-center gap-4 py-8">
									...
									<div className="bg-6 px-5 py-3 rounded-2 text-center d-flex flex-column align-items-center justify-content-center">
										...
										<Link href="https://play.google.com/store/apps/dev?id=5164748430166223403" target="_blank" className="btn btn-dark btn-sm py-1 px-3 rounded-2 d-inline-flex align-items-center bg-black border-secondary shadow-sm">
											<i className="ri-google-play-line me-2 text-primary-1"></i>
											<span style={{ fontSize: '12px', color: '#ffffff', fontWeight: 'bold' }}>Play Store</span>
										</Link>
									</div>
								</div>
								...
								<div className="col-lg-4 d-flex flex-column">
									...
									<div className="d-flex align-items-center mb-4 position-relative d-inline-flex">
										...
										<div className="ps-3">
											...
											<h6 className="mb-0">contact@zelio.com</h6>
										</div>
